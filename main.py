...
def train_attention(feature_columns, train_model_input, train_label, test_model_input, y, patience):
    ...
    model = AutoInt(feature_columns, feature_columns, task='binary', att_layer_num=3, att_embedding_size=8, att_head_num=2,
                    att_res=True,dnn_hidden_units=(256, 256), dnn_activation='relu', l2_reg_linear=1e-5,
                    l2_reg_embedding=1e-5, l2_reg_dnn=0, dnn_use_bn=False, dnn_dropout=0, seed=2024,)
